...
public class PlayerInteractManager {
    ...
    public EnumInteractionResult useItemOn(EntityPlayer entityplayer, World world, ItemStack itemstack, EnumHand enumhand, MovingObjectPositionBlock movingobjectpositionblock) {
        ...
        if (event.useInteractedBlock() == Event.Result.DENY) {
            ...
            if (!flag1) {
                EnumInteractionResult enuminteractionresult1 = iblockdata.useItemOn(entityplayer.getItemInHand(enumhand), world, entityplayer, enumhand, movingobjectpositionblock);
                ...
                if (enuminteractionresult1 instanceof EnumInteractionResult.f && enumhand == EnumHand.MAIN_HAND) {
